...
mod tests {
    ...
    #[test]
    fn test_default_params_in_tests() {
        let default_params = SerializableArgon2Params::default();

        assert_eq!(default_params.m_cost, 8);
        assert_eq!(default_params.t_cost, 1);
        assert_eq!(default_params.p_cost, 1);
        assert_eq!(default_params.output_length, Some(32));
    }

    #[test]
    fn test_default_params_in_production() {
        ...
        let default_params = {
            ...
            #[cfg(test)]
            {
                // Manually create production default parameters
                let default_params = argon2::Params::default();
                SerializableArgon2Params {
                    m_cost: default_params.m_cost(),
                    t_cost: default_params.t_cost(),
        ...
        let argon2_default = argon2::Params::default();

        assert_eq!(default_params.m_cost, argon2_default.m_cost());
        assert_eq!(default_params.t_cost, argon2_default.t_cost());
        assert_eq!(default_params.p_cost, argon2_default.p_cost());
        assert_eq!(default_params.output_length, argon2_default.output_len());
    }
}
