...
use super::{
    node_info::{NodeInfo, NodeInfoExtended},
    packet::Packet,
...
pub enum Message {
    ...
    HandshakeChallenge([u8; 32]), // Nonce challenge for node handshake auth
    HandshakeResponse(Vec<u8>), // Signature over the issued nonce
